...
!(function (a, b) {
  ...
  (function (a, b, c) {
    if ((a.os.android || a.os.ios) && !b.FastClick) {
      var d = function (a, b) {
        return (
          'LABEL' === b.tagName && b.parentNode && (b = b.parentNode.querySelector('input')),
    ...
    var c = Math.round,
      ...
      y = function (b, c) {
        ...
        return (
          e === a.EVENT_START &&
            k - l == 0 &&
            ((c.isFirst = !0), (a.gestures.touch = a.gestures.session = { target: b.target })),
      ...
      if (c.type === a.EVENT_END || c.type === a.EVENT_CANCEL) {
        ...
        ;(d.swipe = !1),
          d.direction &&
            ...
            ((d.swipe = !0), a.trigger(e.target, b, d), a.trigger(e.target, b + d.direction, d))
      }
    }
    a.addGesture({
      name: b,
  ...
  (function (a) {
    ...
    a(function () {
      ...
      a.os.ios
        ...
        : a.os.android && (c.push({ os: 'android', version: a.os.version }), b.add('mui-android')),
        a.os.wechat &&
      ...
      (a.openWindowWithTitle = function (b, f) {
        ...
        if (window.plus) {
          ...
          if (
            ...
            if (
              (p.drawRect(a.options.titleConfig.bottomBorderColor, { top: q + 'px', left: '0px' }),
            ...
            p.setTouchEventRect({ top: '0px', left: '0px', width: '100%', height: '100%' }),
  ...
  (function (a, b, c) {
    ...
    var j = function (a, b) {
      ...
      q = function (a) {
        return (
          a && (a = a.split(';', 2)[0]),
          (a &&
            (a === e ? 'html' : a === d ? 'json' : g.test(a) ? 'script' : h.test(a) && 'xml')) ||
            'text'
        )
      },
      r = function (b, d, e, f) {
    ...
    ;(a.ajax = function (d, e) {
      ...
      if (
        ...
        (f.contentType || (!1 !== f.contentType && f.data && 'GET' !== f.type.toUpperCase())) &&
  ...
  (function (a, b, c) {
    a.offset = function (a) {
      ...
      return (
        ...
        { top: d.top + b.pageYOffset - a.clientTop, left: d.left + b.pageXOffset - a.clientLeft }
      )
    }
  })(mui, window),
  (function (a, b) {
    ...
    var e = 'mui-scroll',
      ...
      l = a.Class.extend({
        ...
        _initSnap: function () {
          ...
          for (
            var a = this.snaps, b = a.length, c = 0, d = -1, e = 0, f = 0, g = 0, h = 0, i = 0;
            i < b;
            i++
          ) {
            var k = a[i],
        ...
        _drag: function (c) {
          ...
          if (
            ('left' === d.direction || 'right' === d.direction
              ...
              : (isReturn = !0),
            (this.moved || f) && (c.stopPropagation(), d.gesture && d.gesture.preventDefault()),
            !isReturn)
          ) {
        ...
        _clearRequestAnimationFrame: function () {
          this.requestAnimationFrame &&
            (cancelAnimationFrame(this.requestAnimationFrame), (this.requestAnimationFrame = null))
        },
        ...
        _momentum: function (a, b, c, e, f, g) {
          ...
          return (
            ...
            (i = j / g),
            h < e
              ? ((h = f ? e - (f / 2.5) * (j / 8) : e), (b = Math.abs(h - a)), (i = b / j))
              : h > 0 && ((h = f ? (f / 2.5) * (j / 8) : 0), (b = Math.abs(a) + h), (i = b / j)),
        ...
        setTranslate: function (b, c) {
          if (
            ...
            e > 1
              ? ((this.parallaxImgStyle.opacity = 1 - (d / 100) * this.options.parallaxRatio),
            ...
            if (m) {
              ...
              if (n.length > 0)
                ...
                if (o) o.innerText = d.slideNumber + 1
                  ...
                  for (
                    var p = m.querySelectorAll('.mui-control-item'), g = 0, h = p.length;
                    g < h;
                    g++
                  )
        ...
        _flick: function (a) {
          if (this.moved) {
            ...
            this._clearRequestAnimationFrame(),
              ...
              'flick' === a.type
                ? (b.deltaTime < 200 &&
                    (this.x = this._getPage(this.slideNumber + ('right' === c ? -1 : 1), !0).x),
                  this.resetPosition(this.options.bounceTime))
                : 'dragend' !== a.type || b.flick || this.resetPosition(this.options.bounceTime),
              a.stopPropagation()
          }
        },
        _initSnap: function () {
        ...
        this.each(function () {
          ...
          if (
            ...
            f
              ...
              : ((f = ++a.uuid), (a.data[f] = d = new l(e, b)), e.setAttribute('data-slider', f))
          }
        }),
        d
      )
      ...
      a.plusReady(function () {
        if (!1 !== window.__NWin_Enable__) {
                  ...
                  if ('circle' == b.options.down.style)
                    ...
                    a.addEventListener('close', function () {
                      ...
                      a.addEventListener(
                        ...
                        function (d) {
                          switch (
                            (b.pulldown ? b.pullPocket.classList.add(e) : b._initPulldownRefresh(),
                            d.status)
                          ) {
              ...
              a.extend(
                {
                  ...
                  disablePulldownToRefresh: function () {
                    ...
                    this.options.down.style && 'circle' == this.options.down.style
                      ? this.options.webview.setPullToRefresh({ support: !1, style: 'circle' })
          ...
          a.fn.pullRefresh_native = function (c) {
            var d
            0 === this.length
              ? ((d = b.createElement('div')), (d.className = 'mui-content'), b.body.appendChild(d))
              : (d = this[0])
            var e = c
            ;(c = c || {}),
  ...
  (function (a, b, c, d) {
      ...
      m = a.Class.extend({
        ...
        handleEvent: function (b) {
          switch (b.type) {
            case a.EVENT_START:
              b.target &&
                !this._preventDefaultException(b.target, this.options.preventDefaultException) &&
                b.preventDefault()
              break
            case 'webkitTransitionEnd':
        ...
        isShown: function (a) {
          ...
          if (this.slideIn)
            b =
              'left' === a
                ? this.classList.contains(j) && this.wrapper.querySelector('.' + e + '.' + j)
                : 'right' === a
                ? this.classList.contains(j) && this.wrapper.querySelector('.' + f + '.' + j)
                : this.classList.contains(j) &&
    ...
    a.registerTarget({ name: d, index: 60, handle: o, target: !1, isReset: !1, isContinue: !0 }),
      b.addEventListener('tap', function (b) {
  ...
  (function (a, b, c, d) {
    ...
    a.registerTarget({ name: d, index: 50, handle: f, target: !1, isReset: !1, isContinue: !0 }),
      b.addEventListener('tap', function (b) {
        a.targets.modal &&
          (b.detail.gesture.preventDefault(), a.targets.modal.classList.toggle('mui-active'))
      })
  ...
  (function (a, b, c, d) {
    ...
    var t = function (a, b, d) {
        if (
          !(('show' === d && a.classList.contains(l)) || ('hide' === d && !a.classList.contains(l)))
        ) {
          o && o.cancel(),
          ...
          ;(a.classList.contains(i) || a.classList.contains(g)) &&
            (a.classList.contains(g) ? ((f = !0), r.classList.add(k)) : r.classList.add(j)),
            u(a, 'block'),
            a.offsetHeight,
            a.classList.add(l),
  ...
  (function (a, b, c, d, e) {
    var f = 'mui-control-item',
      ...
      j = function (a, b) {
        return (
          !(!b.classList || (!b.classList.contains(f) && !b.classList.contains(i))) &&
          ((b.parentNode && b.parentNode.classList && b.parentNode.classList.contains(g)) ||
            a.preventDefault(),
          b)
        )
      }
    a.registerTarget({ name: d, index: 80, handle: j, target: !1 }),
      b.addEventListener('tap', function (b) {
        ...
        if (e) {
          ...
          var o = e === g
          if (
            (e && e.classList.add(l), e.hash && (k = c.getElementById(e.hash.replace('#', ''))))
          ) {
    ...
    ;(k.prototype.init = function () {
      ...
      (k.prototype.drag = function (a) {
        ...
        this.isDragging ||
          ...
          this.isDragging &&
            (this.setTranslateX(b.deltaX), a.stopPropagation(), b.gesture.preventDefault())
      }),
      ...
      (a.fn.switch = function (b) {
        ...
        return (
          this.each(function () {
            ...
            d
              ? (b = a.data[d])
              : ((d = ++a.uuid), (a.data[d] = new k(this)), this.setAttribute('data-switch', d)),
              c.push(b)
          }),
          c.length > 1 ? c : c[0]
        )
      ...
      dragend: function (b) {
        if (z) {
          ...
          if ('open' === d) {
            ...
            if (
              (E(A, i), void 0 !== (g = 'toLeft' === sliderDirection ? buttonsRight : buttonsLeft))
            ) {
          ...
          if (buttonsLeft && buttonsLeft.length > 0 && buttonsLeft !== g)
            for (var k = 0, m = buttonsLeft.length; k < m; k++) {
              ...
              ;(l = n._buttonOffset),
                void 0 === l &&
                  (n._buttonOffset = sliderActionLeftWidth - n.offsetLeft - n.offsetWidth),
                E(n, l)
            }
  ...
  (function (a, b, c) {
        ...
        ;(this.element = a),
          ...
          ~this.options.actions.indexOf('slider')
            ...
            : (~this.options.actions.indexOf('clear') &&
                ((this.clearActionClass = d + ' ' + e + ' ' + k), (this.clearActionSelector = m)),
              ~this.options.actions.indexOf('speech') &&
                ((this.speechActionClass = d + ' ' + f), (this.speechActionSelector = n)),
              ...
              ~this.options.actions.indexOf('password') &&
                ((this.passwordActionClass = d + ' ' + g), (this.passwordActionSelector = o))),
          this.init()
      }
    ;(s.prototype.init = function () {
      ...
      (s.prototype.initAction = function () {
        ...
        c &&
          (b.sliderActionClass
            ? (b.sliderAction = b.createAction(c, b.sliderActionClass, b.sliderActionSelector))
            : (b.searchActionClass &&
                ((b.searchAction = b.createAction(c, b.searchActionClass, b.searchActionSelector)),
                b.searchAction.addEventListener('tap', function (c) {
                  a.focus(b.element), c.stopPropagation()
                })),
              b.speechActionClass &&
                ((b.speechAction = b.createAction(c, b.speechActionClass, b.speechActionSelector)),
                b.speechAction.addEventListener('click', a.stopPropagation),
                b.speechAction.addEventListener('tap', function (a) {
                  b.speechActionClick(a)
                })),
              b.clearActionClass &&
                ((b.clearAction = b.createAction(c, b.clearActionClass, b.clearActionSelector)),
  ...
  (function (a, b) {
    var c = 'mui-active',
      ...
      f = function (c, d) {
        if (
          ((this.element = c),
          (this.options = a.extend({ top: 0, offset: 150, duration: 16, scrollby: b }, d || {})),
        ...
        checkValue: function () {
          ...
          if (null == b || '' == b || isNaN(b))
            ...
            null != a.options.max && !isNaN(a.options.max) && b >= parseInt(a.options.max)
              ...
              : (a.plus.disabled = !1),
              null != a.options.min && !isNaN(a.options.min) && b <= parseInt(a.options.min)
